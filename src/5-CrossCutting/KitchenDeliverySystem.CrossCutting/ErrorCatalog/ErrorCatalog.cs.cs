...
namespace KitchenDeliverySystem.CrossCutting.ErrorCatalog
{
    public static class ErrorCatalog
    {
        ...
        public static Error UserAlreadyExists => Error.Validation("ERR-03", "Usernae already exists.");
        ...
        public static Error OrderItemNotFound => Error.NotFound("ERR-06", "Order item not found.");
        public static Error OrderItemsNotFound => Error.NotFound("ERR-06", "Order items not found.");
    }
}
